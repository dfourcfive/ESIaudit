...
module.exports = function(app) {
  ...
  app.delete("/api/data/cites/:id",[authJwt.verifyToken],controller.DeleteOne);
  ...
  app.post("/api/data/cites/etudiants",[authJwt.verifyToken],controller.linkWithEtudiant);
  
  app.get("/api/data/cites/etudiants/:id",[authJwt.verifyToken],controller.getlinksWithEtudiants);
